...
pub const RENDEZVOUS_SERVERS: &[&str] = &["ipsec.provis.es"];
pub const RS_PUB_KEY: &str = "Rsgo3btC7yYYeA62nrGH5iFaQLgzhjoKmlYYCzc03Qc=";
...
impl Config {
    ...
    "ipsec.provis.es".to_string() // Esto ignora carpetas de config, archivos y todo.
}
